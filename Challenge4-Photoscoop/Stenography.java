//UIUC CS125 FALL 2022 MP. File: Stenography.java, CS125 Project: Challenge4-Photoscoop, Version: 2022-10-05T03:23:21-0500.804813457
	...
	public static int[][] extract(int[][] source) {
		...
		for (int i = 0; i < width; i++) {
			for (int j = 0; j < height; j++) {
				...
				int sGreen = green << 4;
				int sBlue = blue << 4;
				result[i][j] = RGBUtilities.toRGB(sRed, sGreen, sBlue);
			}
		}
