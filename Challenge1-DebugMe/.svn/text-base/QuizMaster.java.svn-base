//UIUC CS125 FALL 2013 MP. File: QuizMaster.java, CS125 Project: Challenge1-DebugMe, Version: 2013-09-10T09:30:04-0500.678307242
/**
...
public class QuizMaster {
	...
	public static void main(String[] args) {
		...
		if(zip/1000 == 48) 
		{
			if (!(gridComputing==1 && illiac==1 && varTF==1 && mosaic==1))
			{
				score = 0;
			}
		}
